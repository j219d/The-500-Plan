    ...
    >
      ...
      {screen === "home" && (
        <>
          ...
          <h3 style={{ display: "flex", alignItems: "center", marginTop: 16 }}>
            Protein
            <button
              onClick={() => setInfoType("protein")}
              style={{
                marginLeft: 8,
                padding: 0,
                border: "none",
          ...
          />
          <p style={{ marginTop: 4 }}>+{caloriesFromSteps} cal from steps</p>
      ...
      {screen === "food" && (
        <>
          {/* ... food search / log UI unchanged ... */}
        </>
      )}

      {screen === "weight" && (
        <>
          {/* ... weight tracker UI unchanged ... */}
        </>
      )}
